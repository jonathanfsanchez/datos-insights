...
from reviews.views import review_dataset_view, review_dataset_create, review_dataset_update, review_model_view, \
    review_model_create, review_model_update, ModelReviewDelete
...
urlpatterns = [
    ...
    # path('dataset/delete/<int:pk>', DatasetReviewDelete.as_view(), name='review_dataset_delete'),
    ...
    path('model/delete/<int:pk>', ModelReviewDelete.as_view(), name='review_model_delete'),
